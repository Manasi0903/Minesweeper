package com.example.manasiminesweeper
...
//    function to set random mines when user first clicks on the board
    ...
    private fun setMines(
        ...
        col: Int,
        mine: Int,
        cellBoard: Array<Array<MineCell>>,
        rowSize: Int,
        colSize: Int
    ) {
        ...
        if (choice == 2) {
            ...
            if (cellBoard[x][y].isRevealed) return false
                ...
                if (flaggedMines == mine) {
                    Toast.makeText(this, "You cannot mark more than $mine mines", Toast.LENGTH_LONG)
                        .show()
                    return false
                }
                flaggedMines++
    ...
    private fun updateScore() {
        ...
        var highScore =
            sharedPref.getInt(getString(R.string.saved_high_score_key), Integer.MAX_VALUE)
